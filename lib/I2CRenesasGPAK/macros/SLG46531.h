...
#define GreenPAK				"SLG46531"

#define VIRTUAL_INPUTS			0xF4	// I2C Virtual Inputs

#define PATTERN_ID				0xE4	// Unique pattern set in Program Settings
...
#define ASM_STATE_0				0xD0	// RAM 8 outputs for ASM-state0
#define ASM_STATE_1				0xD1	// RAM 8 outputs for ASM-state1
#define ASM_STATE_2				0xD2	// RAM 8 outputs for ASM-state2
#define ASM_STATE_3				0xD3	// RAM 8 outputs for ASM-state3
#define ASM_STATE_4				0xD4	// RAM 8 outputs for ASM-state4
#define ASM_STATE_5				0xD5	// RAM 8 outputs for ASM-state5
#define ASM_STATE_6				0xD6	// RAM 8 outputs for ASM-state6
#define ASM_STATE_7				0xD7	// RAM 8 outputs for ASM-state7

#define ASM_OUTPUT				0xF5	// Output for ASM
